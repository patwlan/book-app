...
> This project is a simple demonstration Spec Driven Development using AI.
> All code in this repository was generated by an AI agent following the process outlined in the
> EXAMPLE_PROMPTS.md file.
> Spec Templates are defined in the templates/.
> AGENTS.md are used to define the guardrails for coding agents working in this repository.
> For a comprehensive introduction into Spec Driven Development with the AI, I recommend checking out the following project:
